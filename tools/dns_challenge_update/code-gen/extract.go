...
const legoProvidersSourceFolder = "./lego/providers/dns/"
const legoProvidersInternalSourceFolder = legoProvidersSourceFolder + "internal/"
const outputDir = "./acmedns"
const defTemplate = `package acmedns
/*
...
type ProviderInfo struct {
	...
	ConfigableFields []*Field // Field that should be exposed to user for filling in
...
func main() {
	...
	for _, provider := range providers {
		...
		*/
		...
		var configKeys []*Field
		var hiddenKeys []*Field
	...
	case "` + providerName + `":
		...
		importList += `	"github.com/go-acme/lego/v5/providers/dns/` + providerName + "\"\n"
	}
